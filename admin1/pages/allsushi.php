            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Tambah Menu</a>
                        </li>
						<li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> All Sushi</a>
                        </li>
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Pelanggan</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Pesanan</a>
                        </li>
