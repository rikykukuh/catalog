    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Selamat Datang di Victory Kids</div>
            ...
            <div class="row" >
                <div class="col-lg-12 text-center">
                    ...
                    <div align="justify">
                        ...
                        Pin BBM : D78CF35A ( fash respon ) <br><br>

                        WA : 0897-2331-237 ( fash respon )<br><br>

                        FB : Sanif azies ( victory kids ) new<br><br>

                        IG : Sanif azies Victory kids <br><br>
