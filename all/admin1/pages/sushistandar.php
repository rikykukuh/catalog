...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Menu Sushi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                                                ...
                                                </td><td align="right"><a href="tambahsushi.php"><i class="fa fa-plus" aria-hidden="true"></i>Tambah Data Sushi Disini</a></td></tr></table>
                         </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Deskripsi</th>
											<th width="65px">Jenis</th>
											<th width="65px">Harga</th>
											<th width="65px">Stok</th>
											<th width="65px">Berat</th>
