...
{
 $qry1 = "SELECT * FROM barang WHERE ID=".$_GET['edit1_id'];
...
$img="image/".$filename;
 ...
 {
     $sqlAdd ="update barang set nama='".$nama."',
	 Gambar='".$gambar."',
     Harga='".$harga."',
	 Keterangan='".$keterangan."',
	 harga='".$harga."',
	 where ID=".$_GET['edit1_id'];
                                ...
                                <div class="col-lg-6">
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name = "nama" value="<?php echo $row1['Nama']; ?>"  required >
                                        </div>
										<div class="form-group">
                                            <label>Keterangan</label>
                                            <input type="text area" class="form-control" name = "keterangan" value="<?php echo $row1['Keterangan']; ?>"  required>
                                        </div>
										 <div class="form-group">
                                            <label>Harga</label>
